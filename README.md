...
```
Please note the `::` in this example are correct as in the default interface you can provide a *path* parameter rthat is used e.g. for file or directory providers and has no meaning here so it is kept empty.
